...
{
    gameMusicId = SimpleAudioEngine::sharedEngine()->playEffect("game_music.mp3", true);

}
void SoundManager::PauseGameMusic()
{
    SimpleAudioEngine::sharedEngine()->stopEffect(gameMusicId);//pauseEffect(gameMusicId);
}
void SoundManager::ResumeGameMusic()
{
    gameMusicId = SimpleAudioEngine::sharedEngine()->playEffect("game_music.mp3", true);
}
void SoundManager::PlaySoundGround()
{
	PlaySound("ground");
}
